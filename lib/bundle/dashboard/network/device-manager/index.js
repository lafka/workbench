...
export class DeviceManagement extends React.Component {
   ...
   render() {
      let
         {params} = this.props,
         {computedFacets, facets, view} = this.state,
         SubView = 'table' === view ? DeviceTable : DeviceMap

      const buttons = <ButtonGroup>
                        <Button
                           bsStyle={view === 'map' && "primary" || null}
                           onClick={this.setViewMap.bind(this)}
                           active={view === 'map'}>

                           <Glyphicon title="Network Map" glyph="picture" />
                        </Button>
                        <Button
                           bsStyle={view === 'table' && "primary" || null}
                           onClick={this.setViewTable.bind(this)}
                           active={view === 'table'}>

                           <Glyphicon title="Network Table" glyph="list-alt" />
                        </Button>
                     </ButtonGroup>
